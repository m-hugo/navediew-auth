...
class MyCredentialProviderService: androidx.credentials.provider.CredentialProviderService() {
    private val CREATE_PASSKEY_INTENT = "uk.navediew.kotlinauth.CREATE_PASSKEY"
    private val PERSONAL_ACCOUNT_ID= "PERSONAL_ACCOUNT_ID"
    private val EXTRA_KEY_ACCOUNT_ID  = "uk.navediew.kotlinauth.EXTRA_KEY_ACCOUNT_ID"
    private val UNLOCK_PASSKEY_INTENT = "uk.navediew.kotlinauth.GET_PASSKEY"
    ...
    private fun handleCreatePasskeyQuery(
        _request: BeginCreatePublicKeyCredentialRequest
    ...
    companion object {
        ...
        private const val GET_PASSKEY_INTENT_ACTION = "uk.navediew.kotlinauth.GET_PASSKEY"
